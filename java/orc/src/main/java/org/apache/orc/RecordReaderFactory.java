...
public class RecordReaderFactory {
	...
	public static TreeReaderFactory.TreeReader createTreeReader(int colId,
		...
		List<OrcProto.Type> schemaUsed = getMatchingSchema(fileSchema, null);
		if (schemaUsed == null) {
	...
	//			return null;
	//		}
	//		throw new IllegalStateException("Getting schema on read currently is not supported by this API");
