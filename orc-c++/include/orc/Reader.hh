...
namespace orc {
  ...
  public:
     ...
     * @return this
     */
    ReaderOptions& include(const std::list<int32_t>& include);
     ...
     * @return this
     */
    ReaderOptions& include(std::vector<int32_t> include);
     ...
     */
    const std::list<int32_t>& getInclude() const;
  ...
  public:
     ...
     */
    virtual uint64_t memoryEstimate(int32_t stripeIx = -1) = 0;
