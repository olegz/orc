...
namespace orc {
  ...
  TEST(Int128, testCompare) {
    ...
    EXPECT_EQ(false, x == 124);
    EXPECT_EQ(false, x == -124);
    EXPECT_EQ(false, x == Int128(2, 123));
    EXPECT_EQ(false, x != 123);
    EXPECT_EQ(true, x != -123);
    EXPECT_EQ(true, x != 124);
    EXPECT_EQ(true, x != Int128(-1, 123));
    x = Int128(0x123, 0x456);
    EXPECT_EQ(false, x < Int128(0x123, 0x455));
    EXPECT_EQ(false, x < Int128(0x123, 0x456));
    EXPECT_EQ(true, x < Int128(0x123, 0x457));
    EXPECT_EQ(false, x < Int128(0x122, 0x456));
    ...
    EXPECT_EQ(false, x > Int128(0x123, 0x456));
    EXPECT_EQ(false, x > Int128(0x123, 0x457));
    EXPECT_EQ(true, x > Int128(0x122, 0x456));
    EXPECT_EQ(false, x > Int128(0x124, 0x456));
  ...
  TEST(Int128, testFitsInLong) {
    ...
    EXPECT_EQ(false, Int128(0x0, 0x8000000000000000).fitsInLong());
    EXPECT_EQ(false, Int128(-1, 0x7fffffffffffffff).fitsInLong());
    EXPECT_EQ(true, Int128(-1, 0x8000000000000000).fitsInLong());
    EXPECT_EQ(false, Int128(1, 0x8000000000000000).fitsInLong());
    EXPECT_EQ(false, Int128(1, 0x7fffffffffffffff).fitsInLong());
    EXPECT_EQ(false, Int128(-2, 0x8000000000000000).fitsInLong());
    EXPECT_EQ(false, Int128(-2, 0x7fffffffffffffff).fitsInLong());
